...
- (void)initData
{
    ...
    NSArray *answerArray = @[@"XX先生/女士，您可以先对我们平台做一个简单的了解，并注册您的新融网个人账户，根据您的兴趣在平台首页选择投资项目，点击我要投标按钮，输入金额和验证码，点击确认投资跳转至汇付天下界面，输入交易密码即投资成功",@"XX先生/女士，您好，新融网运用先进的理念和创新的技术建立了一个安全、高效、诚信、透明的互联网金融平台，规范了个人借贷行为，让借入者改善生产生活，让借出者增加投资渠道。平台不仅拥有专业且实力雄厚的人员储备，并与第三方资金托管平台汇付天下进行合作，而且平台上所有投资的项目均有担保公司进行担保。",@"XX先生/女士，请您放心，我们平台拥有专业且实力雄厚的人员储备。新融网拥有资深的技术团队，对网络数据安全，并发处理，金融业务等技术有着丰富的实践经验。与我们合作的第三方托管是汇付天下资金托管平台，汇付天下是获得中国第三方支付牌照的公司，资金年交易量7000亿人民币并受央行监管。并且平台上所有投资项目均有担保公司进行担保，而且我们会和多家担保公司、资产管理公司合作。",@"XX先生/女士，您打开百度搜索www.xr58.com，进入新融网（www.xr58.com），点击右上角注册按钮，填写基本信息，验证手机号激活账户，注册成功。",@"XX先生/女士，您需要注册汇付天下账户托管您的资金，在您激活手机绑定后，点击开通汇付天下账号，页面自动跳转至汇付天下，设置汇付天下登录密码和交易密码，建议密码不一致安全性更高，并且牢记您所设置的密码；完善您的个人信息，点击确定开通成功。"];
